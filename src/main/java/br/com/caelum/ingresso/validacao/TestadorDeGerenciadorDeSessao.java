...
//		System.out.println("Olá");
		...
		// Teste 1
		Filme f = new Filme("Terminador", Duration.ofHours(1), "Ação", null);
		...
		// Teste 2
		f = new Filme("Terminador", Duration.ofHours(3), "Ação", null);
		...
		// Teste 3
		f = new Filme("Terminador", Duration.ofHours(1), "Ação", null);
		s = new Sala("Sala Vip", null);
		sessaoNova = new Sessao(LocalTime.of(22, 0), f, s);
